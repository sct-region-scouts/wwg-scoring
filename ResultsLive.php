...
//Add tools
	...
	echo '<link href="css/style.css"rel="stylesheet" type="text/css" />';
	echo '</head>';
	echo '<body><div class="Menu"><p align="center"><b>Remote DB offline</b></p>';
...
//for stesting only
//$sql = "SELECT * FROM vwscorepatrolhandicap";
...
//			FROM scan INNER JOIN scanvalueresult ON scan.ScanTime=scanvalueresult.ScanTime";
	...
	//echo "Error: Reading to DB . <b>Contact WWG Admin.</b><br>" . $remotedb->error . "<br>" . $sql;
echo "</table>";
 $result->close();
