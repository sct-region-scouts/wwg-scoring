...
echo "</br>";
	...
	while($row = $result->fetch_assoc()){
		echo "<tr>";
	    echo "<td>" . $row['GameTag'] . "</td><td>" . $row['GroupName'] . "</td><td>" . $row['PatrolName'] . "</td><td>" . round($row['Handicap'],4) . "</td><td>" . $row['Score'] . "</td><td>" . round($row['ModScore'],4) . '</td>';
		echo "</tr>";
	}
echo "</table>";
 $result->close();
...
$Scoring->CalculateRawBaseScores();
?>
